    ...
    <div className="grid grid-cols-1 h-screen relative bg-black">
      ...
      <div className="relative z-10 text-center my-auto">
        ...
        <p className="text-white text-base md:text-lg mb-8 max-w-2xl md:max-w-4xl mx-auto">
          We’ll show you how start powerful conversation, drive social engagement, build your brand, hit sales targets or meet other goals you have, wherever you are in the world.  
        </p>
        <div className="flex justify-center">
          <button className="border-2 border-blue-500 hover:border-blue-600 text-white hover:text-white font-bold py-2 px-4 md:px-6 rounded-full flex items-center">
            Work With Us
