            ...
            <div className="my-auto mx-5 xl:mx-24 2xl:mx-28">
                <div className="space-y-8 xl:space-y-10">
                    <div className="flex space-x-2">
                        <div>
                            <h1 className="text-2xl text-center xl:text-left xl:text-6xl 2xl:text-8xl text-white font-extrabold">Career</h1>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="xl:w-1/2">
                            <h1 className="text-xl text-left xl:text-5xl 2xl:text-7xl text-white font-bold">Lorem ipsum dolor sit amet</h1>
                        </div>
