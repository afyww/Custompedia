        ...
        <div className="space-y-10">
          ...
          <div className="xl:w-3/4">
            <p className="text-white font-semibold text-left text-xs xl:text-lg 2xl:text-xl">
              ...
              tristique lorem sem, et semper libero ornare lacinia. Nunc
              efficitur dolor id diam consequat congue. Aenean aliquet facilisis
              augue, vel lobortis lectus vestibulum sed. Integer sit amet mauris
              rhoncus, tincidunt augue quis, tristique nulla. Etiam mattis
              sollicitudin est, sed dictum tortor scelerisque at.
            </p>
          </div>
